  ...
  <div class="causes-details__left-bar">
    <div class="causes-details__img">
      ...
      <div class="causes-details__progress">
        ...
        <div class="causes-details__goals">
          <p><span>Php25,270</span> Raised</p>
          <p><span>Php30,000</span> Goal</p>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-xl-6 col-lg-6">
          <div class="causes-details__images-single">
            <img
              src="~/assets/images/resources/causes-details-images-1.jpg"
              alt=""
            />
          </div>
        </div>
        <div class="col-xl-6 col-lg-6">
          <div class="causes-details__images-single">
            <img
              src="~/assets/images/resources/causes-details-images-2.jpg"
              alt=""
            />
          </div>
        </div>
    ...
    <div class="causes-details__download">
      <div class="causes-details__left">
        <div class="icon">
          <img
            src="~/assets/images/resources/causes-details-download-icon.png"
            alt=""
          />
        </div>
        <div class="text">
